...
public class SearchBoardlistServlet extends HttpServlet{
	private static final Logger logger = LoggerFactory.getLogger(SearchBoardlistServlet.class);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		try {
			...
			list = boardDao.getSearchBoardList(page, limit, keyfield, keyword); 	// 게시물을 LIST 객체에 담습니다. 
