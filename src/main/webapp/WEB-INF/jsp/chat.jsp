   ...
   <div id="chat-image">
      <div id="chat-image-area" >
         ...
         <div id="chat-image-area-tool">
            ...
            <label for="brush" style = "color:black">  ì  ì   ë  ê» :</label> 
         ...
         <div id="chat-image-list">
            <div id="chat-image-list-header">ì ´ë¯¸ì§  ëª©ë¡ </div>
            ...
            <div id="chat-image-list-control">
               <button id="image_add" class="btn-chat btn-info" data-toggle="modal" href="#uploadmodal">ì ´ë¯¸ì§  ì¶ ê° </button>
               <button id="image_delete" class="btn-chat btn-info" onclick=deleteImage()>ì ´ë¯¸ì§  ì  ì  </button>
            </div>
         </div>
      </div>
