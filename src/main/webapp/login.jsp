...
<div class="login-box">
  <div class="login-logo">
    <a href="/T_index.jsp"><b>V</b>iser</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">로그인을 통해 Viser를 시작하세요</p>
    ...
    <a href="/users/createForm" class="text-center">Register a new membership</a>
